...
export default class Q6skillsI extends React.Component{
    render(){
        if(this.props.flag) {
            return (
                <div>
                 <label htmlFor="skillsI" value={this.props.stage}>Which skills do you have in your team (professional experience of at least 1 year, a Master or Bachelor degree or something similar)?</label><br/>
